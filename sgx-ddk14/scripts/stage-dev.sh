...
include="$DESTDIR/usr/include/sgx-ddk14"
...
prefix=/usr
exec_prefix=${prefix}
libdir=/opt/sgx-ddk14/lib
includedir=${prefix}/include/sgx-ddk14

Name: EGL
Description: TI SGX DDK 1.4 EGL soft-float library
Version: 1.4
Libs: -L${libdir} -lEGL
Cflags: -I${includedir}
EOF
...
Name: GLESv2
Description: TI SGX DDK 1.4 OpenGL ES 2 soft-float library
Version: 2.0
